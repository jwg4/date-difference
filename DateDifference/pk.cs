...
{
  public class pk : IDateDifference
  {
    private int numOfDays;
    private int numOfMonths;
    private int numOfYears;

    public void SetDates(DateTime birthDate, DateTime currentDate)
    {
  ...
  public class pk_Test : DateDifferenceTests<pk>
  {
  }
}
